  ...
  Widget build(BuildContext context) => Form(
    ...
    child: Column(
      ...
      children: [
        ...
        _field('supabaseUrl', 'Supabase URL', hint: 'https://xxxx.supabase.co'),
        _field('supabaseKey', '管理 API Key', secret: true),
        _section('Cloudflare R2', '公开域名可以是自定义域名或 R2.dev 地址，用来生成文章中的图片 URL。'),
        _row([
          _field('r2AccountId', 'Account ID'),
          _field('r2Bucket', 'Bucket'),
        ]),
        _row([
          _field('r2AccessKeyId', 'Access Key ID', secret: true),
          _field('r2SecretAccessKey', 'Secret Access Key', secret: true),
        ]),
        _field(
          'r2PublicBaseUrl',
          '公开访问基础 URL',
